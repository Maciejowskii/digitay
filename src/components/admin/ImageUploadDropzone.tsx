    ...
    <div className={`space-y-2 ${className}`}>
      ...
      <div
        ...
        className={`relative w-full border border-dashed transition-all flex flex-col items-center justify-center min-h-[180px] group
          ${value ? "border-zinc-400 bg-zinc-50 cursor-default" 
            : "border-zinc-500 bg-white hover:bg-zinc-50 cursor-pointer"}
      ...
      >
        {isUploading ? (
          ...
          <div className="absolute inset-0 w-full h-full p-2">
            <div className="relative w-full h-full border border-zinc-300 bg-white shadow-sm flex items-center justify-center overflow-hidden group">
          ...
          // Pusta strefa zrzutu
          <div className="flex flex-col items-center text-zinc-700 group-hover:text-zinc-900 transition-colors pointer-events-none p-6 text-center">
            ...
            <p className="text-xs text-zinc-600 font-medium">JPG, PNG, WEBP (Limit: 5MB)</p>
          </div>
        )}
      </div>
