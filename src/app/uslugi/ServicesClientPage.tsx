...
import { ArrowUpRight, ChevronDown, CheckCircle2, Zap, LayoutTemplate, Smartphone, GaugeCircle } from "lucide-react";
import ServicesBento from "@/components/ServicesBento";
import Navbar from "@/components/Navbar";
import Footer from "@/components/Footer";
import { useState, useRef } from "react";

// Mock content dla sekcji "Podejście"
const DOMAINS = [
  {
    id: "01",
    icon: GaugeCircle,
    ...
    desc: "Z każdą sekundą ładowania strony tracisz klientów. Architektury, które wdrażamy w środowiskach takich jak Next.js czy Vercel ładują się błyskawicznie, uzyskując 100/100 punktów Google Lighthouse. Nie znosisz wolno działającego internetu? Twoi klienci też nie.",
  },
  {
    id: "02",
    icon: LayoutTemplate,
  ...
  },
  {
    ...
    desc: "Odrzucamy gotowe, obciążające systemy. Piszemy aplikacje (Headless, Native) rozwiązujące Twoje konkretne wąskie gardła. Twój system powinien dopasowywać się do Ciebie, a nie Ty do systemu.",
  }
];
            ...
            <div className="lg:col-span-5 relative">
              <div className="lg:sticky lg:top-40">
                ...
                <p className="text-white/40 text-lg md:text-xl leading-relaxed max-w-md">
                  W dobie przeciętności, rewelacyjna szybkość i design wyróżnią Cię natychmiast. Porzucamy uciążliwe gotowce na rzecz natywnych rozwiązań, które konwertują.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 flex flex-col gap-8 md:gap-12 pt-8 lg:pt-0">
              {DOMAINS.map((domain, i) => (
                <motion.div
                  ...
                  transition={{ duration: 0.7 }}
                  className="p-8 md:p-12 rounded-3xl border border-white/5 bg-gradient-to-br from-white/[0.03] to-white/[0.01] hover:bg-white/[0.04] transition-colors group relative overflow-hidden"
                >
                  ...
                  <div className="absolute right-8 top-8 text-7xl font-heading font-black text-white/[0.03] group-hover:text-primary/[0.05] transition-colors pointer-events-none select-none">
                    {domain.id}
                  </div>
                  ...
                  <span className="text-primary tracking-widest uppercase text-sm font-bold block mb-6 relative z-10">{domain.subtitle}</span>
